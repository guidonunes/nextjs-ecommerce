...
export default function ProductCard({ produto }: ProdutoCardProps) {
  return (
    <Link href={`/ produtos / ${ produto.id }`} className="bg-[#31394c] border border-gray-700 rounded-lg p-6 py-7 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
